...
class GuestMaterialListPage extends Component {
	constructor(props) {
		super(props);
	...
	componentWillUnmount() {
  	...
  	viewDetails(materialName) {
		...
		Actions.GuestMaterialDetailPage({materialName});
  	}
...
GuestMaterialListPage.contextTypes = contextTypes;
export default AuthenticatedComponent(GuestMaterialListPage);
