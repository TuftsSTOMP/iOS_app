...
class GuestMaterialDetailPage extends Component {
	constructor(props) {
		super(props);
		this.state = {
...
GuestMaterialDetailPage.contextTypes = contextTypes;
export default AuthenticatedComponent(GuestMaterialDetailPage);