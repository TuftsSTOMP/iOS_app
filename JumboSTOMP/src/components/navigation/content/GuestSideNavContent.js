...
const GuestSideNavContent = (props, context) => {
...
GuestSideNavContent.contextTypes = contextTypes;
GuestSideNavContent.propTypes = propTypes;
export default GuestSideNavContent;